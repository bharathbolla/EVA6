...
## Take Home Message
Replacing Maxpool layer with either stride =2 conv layers or dilation > 2 layers, there is no special gain. This results in more model parameters but the convergence becomes slow.
